"""Spearman / multi-indicator moment estimators for AF starting values.

Pure NumPy helpers used to seed AF optimizer starting values from data
...
edge cases. See `af-sigma-inv-identification-analysis-2026-05-08.md` in
the user's obsidian vault for the theoretical background.
"""
