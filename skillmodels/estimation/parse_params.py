...
def _map_params_to_deltas(params, initial, params_slice, boo, replacements=None):
...
def _map_params_to_R(
    params, initial, params_slice, boo, square_root_filters, replacements=None
):
...
def _map_params_to_X_zero(params, initial, filler, params_slice, replacements=None):
...
def _map_params_to_trans_coeffs(
    params,
    initial,
    params_slice,
...
def restore_unestimated_quantities(
    X_zero=None, X_zero_value=None, W_zero=None, W_zero_value=None
):
...
def transform_params_for_X_zero(
    params_for_X_zero, filler, direction, replacements=None
):
...
def transform_params_for_P_zero(
    params_for_P_zero, filler, boo, estimate_cholesky_of_P_zero, direction
):
...
def transform_params_for_trans_coeffs(
    params, initial, params_slice, transform_funcs, included_factors, direction
):
