...
class TestRewriteNormalizationsForTimeInvariantMeasurements:
    def setup(self):
        ...
        self.df_inter_problem = pd.DataFrame(columns=cols, data=dat_inter).set_index(
            ["period", "variable"]
        )
...
class TestNewMeasCoeffs:
    def setup(self):
        ...
        dat = [
            [0, "m1", 1.0, 0.0, 1.0, 0.0, 0.5, 0.9, True, True, False],
            [0, "m2", 1.0, 0.0, 0.0, 0.0, nan, nan, False, False, False],
            [0, "m3", 0.0, 1.0, 0.0, 1.5, nan, nan, False, False, False],
            [0, "m4", 0.0, 1.0, 0.0, 0.0, 0.7, nan, True, False, False],
            [1, "m1", 1.0, 0.0, 1.0, 0.0, 0.5, 0.9, True, True, True],
            [1, "m2", 1.0, 0.0, 0.0, 0.0, nan, nan, False, False, True],
            [1, "m3", 0.0, 1.0, 0.0, 1.5, nan, nan, False, False, False],
            [1, "m4", 0.0, 1.0, 0.0, 0.0, 0.7, nan, True, False, False],
        ]

        df = pd.DataFrame(data=dat, columns=cols).set_index(["period", "variable"])
        ...
        df_without = pd.DataFrame(columns=cols, data=dat_without, index=df.index)
